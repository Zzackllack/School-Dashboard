...
public record CreateSurveySubmissionRequest(@NotBlank(message = "displayId ist erforderlich") String displayId,
		@NotNull(message = "Kategorie ist erforderlich") SurveyCategory category,
		@NotBlank(message = "Nachricht ist erforderlich") @Size(min = 10, max = 2000, message = "Nachricht muss zwischen 10 und 2000 Zeichen lang sein") String message,
