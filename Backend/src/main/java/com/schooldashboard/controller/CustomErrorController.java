	...
	public String handleError(HttpServletRequest request, Model model) {
		...
		if (status != null) {
			...
			if (statusCode == HttpStatus.NOT_FOUND.value()) {
				...
				model.addAttribute("errorMessage",
						errorMessage != null ? errorMessage : "You do not have permission to access this resource");
				return "error/403";
			}
		}
		...
		// Logging
		logger.error("Error occurred: {} (Status code: {})", model.getAttribute("errorMessage"),
