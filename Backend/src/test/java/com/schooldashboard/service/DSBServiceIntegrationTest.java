...
public class DSBServiceIntegrationTest {
  ...
  @Autowired private DSBService dsbService;

  @Autowired private ApiResponseCacheService cacheService;

  @MockBean private DsbClient dsbClient;

  @Test
  public void returnsCachedTimeTablesWhenClientFails() {
    UUID uuid = UUID.fromString("a05eab4c-af64-49f8-b8e6-e608269ebc05");
    cacheService.store(
        ApiResponseCacheKeys.DSB_TIMETABLES,
        List.of(
            Map.of(
                "uuid", uuid.toString(),
