      ...
      <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-lg border border-white/20 p-5 mb-5 w-full transition-all duration-300">
        ...
        {!loading && substitutionPlans.length === 0 && !error && (
          <div className="bg-[#F5EFD7] border border-[#DDB967] text-[#8C7356] px-4 py-3 rounded">
            Keine Vertretungspläne verfügbar. Ist DSBmobile offline oder hat
            DSBMobile ihre API geändert?
          </div>
        )}
      </div>
            ...
            <>
              ...
              <div className="overflow-x-auto w-full">
                <table className="min-w-full border-collapse">
                  <thead>
                    <tr>
                      <th className="bg-gray-700/90 text-white backdrop-blur-md border-b border-white/10 px-4 py-3 text-left rounded-tl-lg">
                        Klasse
                      </th>
                      <th className="bg-gray-700/90 text-white backdrop-blur-md border-b border-white/10 px-4 py-3 text-left">
                        Stunde
                      </th>
                      <th className="bg-gray-700/90 text-white backdrop-blur-md border-b border-white/10 px-4 py-3 text-left">
                        Fehlenend
                      ...
                      <th className="bg-gray-700/90 text-white backdrop-blur-md border-b border-white/10 px-4 py-3 text-left rounded-tr-lg">
                        Kommentare
                      </th>
                    </tr>
                  </thead>
                    ...
                    {plan.entries.map((entry, entryIndex) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="border-b border-gray-100/30 px-4 py-3">
                            {entry.period}
                          </td>
                          <td className="border-b border-gray-100/30 px-4 py-3">
                            {entry.absent}
                          ...
                          <td className="border-b border-gray-100/30 px-4 py-3 italic">
                            {entry.comment}
                          </td>
                        </tr>
                      );
